...
//       matchesLocation = eventLocLower.includes(filterLower);
//     }
...
//     if (dateRange.start) matchesDate = matchesDate && new Date(event.date) >= new Date(dateRange.start);
//     if (dateRange.end) matchesDate = matchesDate && new Date(event.date) <= new Date(dateRange.end);
...
//         setTimeout(async () => {
//           try {
//             const response = await fetch(`http://localhost:5000/api/users/favorites/${pendingAction.eventId}`, {
//               method: 'POST',
//               headers: {
//                 'Content-Type': 'application/json'
//               },
