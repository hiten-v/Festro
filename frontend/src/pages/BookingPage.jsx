...
//         console.log('Booking attempt for event:', event._id);
...
//                 body: JSON.stringify({
//                     eventId: event._id,  // Important: field name must be eventId
...
//                 throw new Error(errData.message || `Booking failed: ${response.status}`);
//             }
...
//                             <span className="font-bold text-[#702c2c]">₹{finalAmount.toFixed(0)}</span>
//                         </div>
//                     </div>
//                     <button
//                         onClick={() => navigate('/events')}
...
//                                         <span className="block text-2xl font-extrabold text-[#702c2c]">₹{finalAmount.toFixed(0)}</span>
//                                         <span className="text-[10px] text-stone-400 uppercase tracking-wide">Included all taxes</span>
//                                     </div>
//                                 </div>
//                             </div>
